...
file_4 = URI.open("https://res.cloudinary.com/tassilobrecht/image/upload/v1654257281/tent2_zm0wr7.jpg")
...
tent_4.photo.attach(io: file_4, filename:"nes.jpg", content_type: "image/jpg")

file_5 = URI.open("https://res.cloudinary.com/tassilobrecht/image/upload/v1654257491/phoxx22_ycfda4.jpg")
tent_5 = Tent.create!(title: "Phoxx 2 Tent", description: " A compact, lightweight, waterproof shelter, pick up an OEX Phoxx 2 Tent. As well as providing a robust structure, the pre-angled pole design also pro vides porch space to store wet kit. The breathable inner tent section can be used on its own on warm days for a more comfortable place to rest.", capacity: "2 people", location: "Shoreditch", price: "35 PPD", user: tassilo )
...
tent_6 = Tent.create!(title: "10x15m Marquee", description: "Compact in storage, lightweight and easy to assemble: Our Economy PE marquees from our Product Line Optiline offer a particularly quick set up thanks to the high-quality click-in system. The fully galvanised steel frame is protected against corrosion. ", capacity: "100 people", location: "Barnet", price: "89 PPD", user: tassilo )
